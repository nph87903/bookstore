...
<% 
            ...
            //*** Load the jdbc-odbc bridge driver
                ...
                while(rs.next())
                {
                	String insert="INSERT INTO  specialproducts VALUES ("+rs.getString(1)+",'"+rs.getString(2)+"','"+rs.getString(3)+"','"+rs.getString(4)+"','"+specialprice+"','"+rs.getString(5)+"',"+rs.getString(6)+",'"+rs.getString(7)+"','"+rs.getString(8)+"','"+rs.getString(9)+"','"+rs.getString(10)+"' )";
